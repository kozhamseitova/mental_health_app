...
const TextStyle tsWelcomePageTitle = TextStyle(color: cTextColor, fontSize: 36, fontWeight: FontWeight.bold, fontFamily: 'Lobster');
const TextStyle tsWelcomePageSubTitle = TextStyle(color: cTextColor, fontSize: 20, fontWeight: FontWeight.w600, fontFamily: 'Rubik');
const TextStyle tsButton = TextStyle(color: cTextColor, fontSize: 24, fontWeight: FontWeight.bold, fontFamily: 'Rubik');
const TextStyle tsHaveAccount = TextStyle(color: cSubTextColor, fontSize: 14, fontWeight: FontWeight.w300, fontFamily: 'Rubik');
const TextStyle tsSignInSmall = TextStyle(color: cTextColor, fontSize: 16, fontWeight: FontWeight.w400, fontFamily: 'Rubik');


const TextStyle tsLoginTitle = TextStyle(color: cTextColor, fontSize: 24, fontWeight: FontWeight.bold, fontFamily: 'Rubik');
const TextStyle tsLoginSubTitle = TextStyle(color: cTextColor, fontSize: 16, fontWeight: FontWeight.w300, fontFamily: 'Rubik');
const TextStyle tsInputs = TextStyle(color: cSubTextColor, fontSize: 16, fontWeight: FontWeight.w300, fontFamily: 'Rubik');
const TextStyle tsForgetPassword = TextStyle(color: cSubTextColor, fontSize: 12, fontWeight: FontWeight.w300, fontFamily: 'Rubik');
...
const TextStyle tsMeditationPageSubTitle = TextStyle(color: cTextColor, fontSize: 14, fontWeight: FontWeight.w300, fontFamily: 'Rubik');
